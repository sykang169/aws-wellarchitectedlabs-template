...
export declare class DatabaseClusterEngine {
    static readonly AURORA: DatabaseClusterEngine;
    static readonly AURORA_MYSQL: DatabaseClusterEngine;
    static readonly AURORA_POSTGRESQL: DatabaseClusterEngine;
    /**
     * The engine.
     */
    ...
    private readonly parameterGroupFamilies?;
     ...
     */
    parameterGroupFamily(engineVersion?: string): string | undefined;
}
/**
